...
@Inject
class TvDataRepositoryImpl(
    private val dataRepository: TvDataRepository,
) : TvRepository {
    override suspend fun getTvList(pageCount: Int): AppResult<List<HomeEpisodeOverView>> = dataRepository.getTvList(pageCount)
}
